	...
	<div class="card card-body p-5">
		...
		<section id="variables">
			...
			<ol>
				...
				<li> $_REQUEST - an associative array containing the value of HTTP Request variables ($_GET, $_POST and $_COOKIE).
				</li>
				<li> $_SESSION - an associative array which contains session variables available to the current script.
				</li>
				<li> $_ENV - an associative array containing the variables passed via the environment method. These variables are coming from the environment under which the PHP parser is running.
				</li>
