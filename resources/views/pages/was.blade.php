...
<div class="container" id="content">
	<div class="card card-body p-5">
		<section id="what-is-was">
			...
			<p>WAS is a security on websites, applications and web services. WAS was basically based on applications but was later then applied to the internet and its web systems.</p>
		</section>
		<hr>
		<section id="sample-case">
			<p>If you frequently order food through the website of <img src="{{asset('storage/img/jollibee.jpg')
                }}" alt="Jollibee">, you’re probably disappointed to have seen the picture below when you opened their website to order <img src="{{asset('storage/img/burger.png')}}" alt=""><img src="{{asset
                    ('storage/img/coke.jpg')}}" alt=""><img src="{{asset('storage/img/fries.png')}}" alt="">.</p>
			<img src="{{ asset('storage/img/jolli-web.PNG') }}" alt="Jollibee Website" class="img-fluid justify-content-center">
			<hr>
			<h3>Sample Case</h3>

			<p>If you frequently order food from jollibeedelivery.com which the official website of Jollibee you’re probably disappointed to have seen the picture below when you opened their website to order food.
			</p>
		...
		<section id="data-pri-act">
			...
			<p class="m-5">The Data Privacy Act was enforced in order to ensure the presence of security in web applications.
			</p>
		</section>
		<hr>
		<hr>
		<section id="top-10">
			<div class="jumbotron">
				...
				<p>
					For this lesson, we will be focusing on 3 web application security. The remaining security risks will be covered soon. Come back after a week if you want to know more about the reamining security risk.
				</p>
			</div>
		...
		<section id="bA">
			...
			<p>Broken authentication is a security risk which occurs when a hacker makes use of valid combinations of compromised account credentials, and try those combinations to enter a login page or any page that requires authentication, posing as an authentic user. Broken authentication is the result of poor authentication implementations. For example, session IDs are explicitly embedded in URLs, and unencrypted user data are transmitted to servers. Functions such as the Reset or Forgot Password are mostly exploited in this vulnerability, and are used by the attacker in order to retrieve the details of an account. </p>
			<b>Mitigation Tips</b>
			<ol>
				<li>Setting strong passwords at least eight characters long with the use of special characters and uppercase letters. Temporarily deny login service if there were too many failed attempts.
				</li>
				<li>Set session timeouts when there is no user activity.</li>
				<li>When a wrong credential is entered, there should be an output saying “Invalid password/username” instead of “Invalid password” or “Invalid username”.
				</li>
		...
		<section id="bb">
			...
			<ol>
				...
				<li>Components should be analyzed for insecure codes (such as codes unintentionally allowing users to access private files or even sensitve compueter processes) remove or update old library components that may potentially be vulnerable</li>
			...
			<div class="col">
				<img src="{{asset('storage/img/InsufficientLogging.png')}}" alt="Insufficient Logging m-4" class="img-fluid">
			</div>
			<b>Sample Case</b>
		...
		<section id="references">
			<h3>References</h3>
			News, A. (2018). Jollibee takes down delivery website after gov't raises privacy concern. [online] ABS-CBN News. Available at: http://news.abs-cbn.com/business/05/09/18/jollibee-takes-down-delivery-website-after-govt-raises-privacy-concern [Accessed 11 May 2018].<br> Owasp.org. (2018). Top 10-2017 Top 10 - OWASP. [online] Available at: https://www.owasp.org/index.php/Top_10-2017_Top_10 [Accessed 11 May 2018].<br>
		</section>
		<hr> @if (Auth::user())
