    ...
    <div class="container" id="content">
        <div class="card card-body p-5">
            ...
            <section id="bA">
                ...
                <p>
                    Broken authentication is a security risk which occurs when a hacker makes use of valid combinations
                ...
                <p>
                    ...
                    and used them to enter the accounts of TaxSlayer customers. TaxSlayer LLS only noticed the attack in
                    January 2016, when a customer of complained that hackers used their information to obtain tax
                    refunds by filing fake tax returns with altered bank routing numbers directed to the hackers
                    (Feigelson, J., & Bucher, W.). In order to end the attack, the TaxSlayer imposed multi-factor
                    authentication requirements. The Federal Trade Commission, who is working on this issue, filed their
                    final approval of settlement with TaxSlayer LLC on November 8, 2017, containing the rules TaxSlayer
                    must follow to continue its services (FTC, 2018).
                </p>
            </section>
            <hr>
            <section id="bb">
                <h3>Using Components with Known Vulnerabilities</h3>
                <p>Codes nowadays tend to link to open-source external components such as modules, libraries, and
                    ...
                    companies or developers that use these components. Not every component can affect different
                    applications in the same way. This solely depends on how deeply embedded these components are inside
                    the software and programs that use them. As these components run on the same access level as the
                    application that uses them, attackers can exploit vulnerable components to access sensitive
                    information and perform tasks that can compromise the companies that use these components.</p>
                <b>Mitigation Tips</b>
                <ol>
            ...
            <section id="bc">
                ...
                <p>Insufficient logging and monitoring is a situation where some user activities within the website are
                    not recorded. It is also the case when all user activities are logged but important details such as
                    activity, time in, time out, or even frequency of visits are not recorded. Not being able to track
                    any suspicious activities or sensitive actions happening within an application or a system, such as
                    change of passwords, financial transactions, or not being able to store logs, properly give way for
                    attackers to prevent or damage security controls. The lack of logs causes security breaches to
                    remain undetected, which allows attackers to have more time to escalate further into the application
                    or the system, and to further exploit stolen data. The said attacks will, in turn, result in a more
                    difficult and longer process of repairing any damage done and/or recovering any data loss.</p>
                <b>Mitigation Tips</b>
                <ol>
                    <li>proper logging and monitoring system must be planned and developed to track all activity within
                        the application, suspicious or not
                    </li>

                    <li>Alerts concerning suspicious activities must also be ensured that they are effective enough and
                        that an incident response and recovery plan is well established
                    </li>
                    <li>a penetration test must also be conducted wherein the system will be tested if it successfully
                ...
                <p>
                    ...
                    card details and passwords of over 2 million customers. Though unclear of when the breach took
                    place, it appeared that the hackers were able so successfully compromise an internal server on their
                    network. A software which could have alerted the company of the attack as soon as the breach
                    happened and in turn would have mitigated the breach was believed to be absent.</p>
            </section>
            <hr>
